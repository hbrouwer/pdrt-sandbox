...
\begin{definition}[Free Projection Variables]~
  \begin{enumerate}[i.]
...
%Thus, a projected referent is bound in case there exists some referent
%pointing to an accessible context in any universe in the global PDRS. 
  ...
  \begin{enumerate}[i.]
    \item $\mathcal{B}(\langle l, M, U, C \rangle,R,A) 
      ...
      where: $R' = R \cup U$;
             ...
             %%%XXX NB I removed def for \preceq!!
