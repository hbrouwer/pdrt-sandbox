\section{The projection behaviour of presuppositions and CIs}
...
$5\gets$psychopath(z)\\ $5\gets$z=y\\ $2\gets$fit-to-watch-kids(y)}{$2 \leq 4$
~~$2<5$~~$5=4$}}{$1 \leq 3$}
\pdrs{1}{$3\gets$x~~$1\gets$p}{$3\gets$Sheila(x)\\ $1\gets$believes(x,p)\\
$1\gets$p:\pdrs{2}{$4\gets$y}{$4\gets$Chuck(y)\\ 
$4\gets$psychopath(y)\\ $2\gets$fit-to-watch-kids(y)}{$2<4$}}{$1 \leq 3$}
...
$5\gets$stole\_from(x,y)\\ $1\gets$behind\_bars(x)}{
$1 \leq 3$~~$1<5$~~$5 \leq 4$~~$5=3$}
...
$5\gets$reported(y,p)\\ $2\gets$spy(x)}{$2 \leq 3$~~$2<5$~~$5 \leq 4$~~$5=3$}}{}
